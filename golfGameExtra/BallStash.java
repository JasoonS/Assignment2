...
public class BallStash {
	private AtomicInteger sizeStash;
	...
	BallStash(AtomicInteger sizeStash, AtomicInteger sizeBucket, AtomicBoolean done){
	...
	public boolean getBucketBalls(Queue<golfBall> golferBucket, int myID) throws InterruptedException {
		...
		synchronized(stash){
			...
			for(int i = 0; i < sizeBucket.get(); i++) {
